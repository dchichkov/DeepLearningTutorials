...
def test_SdA( finetune_lr = 0.4, pretraining_epochs = 25, \
              pretrain_lr = 0.4, training_epochs = 25, \
              dataset='../data/mnist.pkl.gz', batch_size = 200):
    """
